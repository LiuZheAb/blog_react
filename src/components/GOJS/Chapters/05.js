            ...
            <div className="page-content">
                <div className="article">
                    ...
                    <div className="article-content">
                        ...
                        <div className="text-center"><button onClick={this.save} style={{ marginRight: "20px" }}>Save</button><button onClick={this.load} style={{ marginRight: "20px" }}>Load</button><button onClick={this.check}>下载查看JSON数据</button></div>
