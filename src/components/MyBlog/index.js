            ...
            <div className="myblog-content">
                <div className="article">
                    ...
                    <div className="article-content">
                        ...
                        <p className="indent-2">想建站但是不想花钱买服务器，穷呀，怎么办？乖乖百度找办法，然后发现了github-pages（以下简称gh）这个好东西，可以拿来做个人博客，虽说github在国内访问的速度不太快吧（这个说法可能谦虚了），但是它免费呀，还挑啥。So，开始研究gh怎么用。</p>
                        <p className="indent-2">第一时间想到的就是最笨的方法，纯HTML、CSS肯定是行得通的。而且语雀有自带的将文档转为HTML的功能，还是很好用的，所以就想着先在语雀里写好文档，再转成HTML，然后在需要的位置插入代码。随后把想法测试了一下，放到gh上没问题，开心。</p>
                        ...
                        <p className="indent-2">工具找好了，下一步是什么？使用？别急，先找教程，省时省力不掉坑。找了有几篇，最后参考的是这个<a href="https://zhuanlan.zhihu.com/p/88481760" target="_blank" rel="noopener noreferrer">https://zhuanlan.zhihu.com/p/88481760</a>，文章写得很详细，手把手教学，可是我上来就忽略了第一点，<b>仓库名应该为：用户名.github.io </b>，后边的泪就不提了。。。</p>
                        ...
                        <p className="indent-2">测试了一下，将React打包后的代码丢到gh上，可行，于是就这么愉快地决定了。</p>
                        <br />
                        <p className="indent-2">以上基本上就是建站的整个新路历程。</p>
                        <br />
