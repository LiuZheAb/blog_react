            ...
            <div className="page-content">
                <div className="article">
                    ...
                    <div className="article-content">
                        <p className="indent-2">屏幕阅读器用户对于他们的设备读取的内容类型有不同的选择。这包括跳转到(或跳过)锚点元素。跳转到主要内容。或者从标题中获取页面摘要。另一种选择是只听页面上可用的链接。</p>
                        <p className="indent-2">屏幕阅读器通过阅读链接文本或 a 标签之间的内容来实现这一点。“点击这里”或“阅读更多”链接是没有帮助的。相反，您应该在a标签中使用简短但具有描述性的文本，以便为这些用户提供更多的含义。</p>
