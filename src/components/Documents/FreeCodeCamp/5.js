            ...
            <div className="page-content">
                <div className="article">
                    ...
                    <div className="article-content">
                        ...
                        <h2>概述</h2>
                        <p><b>CSS animations</b> 使得可以将从一个 CSS 样式配置转换到另一个 CSS 样式配置。动画包括两个部分:描述动画的样式规则和用于指定动画开始、结束以及中间点样式的关键帧。</p>
                        ...
                        <h2>配置动画</h2>
                        <p>创建动画序列，需要使用 animation 属性或其子属性，该属性允许配置动画时间、时长以及其他动画细节，但该属性不能配置动画的实际表现，动画的实际表现是由 @keyframes 规则实现，具体情况参见使用 keyframes 定义动画序列小节部分。</p>
                        <p>animation 的子属性有:</p>
                        <ul style={{ listStyle: "none" }}>
                            <li style={{ marginLeft: 0 }}><b>animation-delay</b></li>
                            <p style={{ marginLeft: "1.5em" }}>设置延时，即从元素加载完成之后到动画序列开始执行的这段时间。</p>
                            <li style={{ marginLeft: 0 }}><b>animation-direction</b></li>
                            <p style={{ marginLeft: "1.5em" }}>设置动画在每次运行完后是反向运行还是重新回到开始位置重复运行。</p>
                            <li style={{ marginLeft: 0 }}><b>animation-duration</b></li>
                            <p style={{ marginLeft: "1.5em" }}>设置动画一个周期的时长。</p>
                            <li style={{ marginLeft: 0 }}><b>animation-iteration-count</b></li>
                            <p style={{ marginLeft: "1.5em" }}>设置动画重复次数， 可以指定 infinite 无限次重复动画</p>
                            <li style={{ marginLeft: 0 }}><b>animation-name</b></li>
                            <p style={{ marginLeft: "1.5em" }}>指定由 @keyframes 描述的关键帧名称。</p>
                            <li style={{ marginLeft: 0 }}><b>animation-play-state</b></li>
                            <p style={{ marginLeft: "1.5em" }}>允许暂停和恢复动画。</p>
                            <li style={{ marginLeft: 0 }}><b>animation-timing-function</b></li>
                            <p style={{ marginLeft: "1.5em" }}>设置动画速度， 即通过建立加速度曲线，设置动画在关键帧之间是如何变化。</p>
                            <li style={{ marginLeft: 0 }}><b>animation-fill-mode</b></li>
                            <p style={{ marginLeft: "1.5em" }}>指定动画执行前后如何为目标元素应用样式。</p>
                        </ul>
                        <h2>使用keyframes定义动画序列</h2>
                        <p>一旦完成动画的时间设置， 接下来就需要定义动画的表现。通过使用 @keyframes 建立两个或两个以上关键帧来实现。每一个关键帧都描述了动画元素在给定的时间点上应该如何渲染。</p>
                        <p>因为动画的时间设置是通过 CSS 样式定义的，关键帧使用 percentage 来指定动画发生的时间点。0% 表示动画的第一时刻，100% 表示动画的最终时刻。因为这两个时间点十分重要，所以还有特殊的别名：from 和 to。这两个都是可选的，若 from/0% 或 to/100% 未指定，则浏览器使用计算值开始或结束动画。</p>
                        ...
                        <p>第二帧出现在 100%(此例中使用了别名 to)。元素的左边距设为 0%，宽设为 100%，使得动画结束时元素与窗口左边界对齐。</p>
                        ...
                        <p>以上是非常标准的代码写法，setup()最后设置动画元素的 class 为 slidein，启动动画。</p>
                        ...
                        <p>{`这段代码同样非常简单，简单地通过 event.type 来判断发生的是何种事件，然后添加对应的注解到<ul>中。`}</p>
