            ...
            <div className="page-content">
                <div className="article">
                    ...
                    <div className="article-content">
                        ...
                        <CodeMirror
                            value={`grid-template-columns: auto 50px 10% 2fr 1fr;`}
                            options={{
                                theme: 'monokai',
                                mode: 'CSS',
                                readOnly: true,
                        ...
                        <p className="indent-2">要控制项所占列的数量，可以将 grid-column 属性设置为如下形式：</p>
                        <CodeMirror
                            value={`grid-column: 2 / 4;`}
                            options={{
                                theme: 'monokai',
                                mode: 'CSS',
                                readOnly: true,
                        ...
                        <h2>grid-row</h2>
                        <p className="indent-2">grid-row 控制项所占行数,用法与 grid-column 一致。</p>
                    </div>
                </div>
                <Directory />
            </div>
