...
export default class index extends Component {
    ...
    componentDidMount() {
        document.title = "Code Review——代码评审标准";
        this.getArticleTree();
    }
    render() {
        return (
            <div className="page-content">
                <div className="article">
                    ...
                    <div className="article-content">
                        ...
                        <p className="indent-2"><b>一般来说，只要CL确实提高了正在处理的系统的整体代码健康度，评审人员就应该赞成此CL，即使此CL不是完美的。</b></p>
                        <p className="indent-2">这是所有代码评审指南中的高级原则。</p>
                        <p className="indent-2">当然，这也有局限性。例如，如果CL添加了评审人员不希望在其系统中使用的功能，那么即使代码设计良好，评审人员也可以拒绝批准。</p>
                        <p className="indent-2">这里的一个关键点是，没有“完美”的代码，只有更好的代码。评审人员不应该要求作者在批准之前对CL的每一个微小部分进行打磨。相反，评审人员应该权衡取得进展的需要和他们所建议的变更的重要性。评审人员不应该追求完美，而应该追求持续的改进。作为一个整体，提高系统可维护性、可读性和可理解性的CL不应该因为它不是“完美的”而被延迟几天或几周。</p>
                        <p className="indent-2">评审人员应该随时留下评论，表示有些东西可以做得更好，但是如果不是很重要，可以在前面加上“Nit:”这样的前缀，让作者知道这只是一种修饰，他们可以选择忽略。</p>
                        <p className="indent-2">注意:本文档中没有任何内容证明签入CLs肯定会恶化系统的整体代码健康状况。只有在<a href="https://github.com/google/eng-practices/blob/master/review/emergencies.md" target="_blank" rel="noopener noreferrer">紧急情况</a>下你才会这么做。</p>
                        <h2>指导</h2>
                        <p className="indent-2">代码评审的一个重要功能是教开发人员关于语言、框架或一般软件设计原则的新知识。留下帮助开发人员学习新东西的评论总是好的。随着时间的推移，共享知识是改善系统代码健康状况的一部分。请记住，如果您的评论纯粹是教育性的，但对于满足本文档中描述的标准并不是至关重要的，那么在它前面加上“Nit:”，或者以其他方式表明作者并不强制在本CL中解决它。</p>
                        <h2>原则</h2>
                        ...
                        <p className="indent-2">当达成一致意见变得特别困难时，在评审人员和作者之间进行面对面的会议或风险投资将会有所帮助，而不是仅仅试图通过代码评审的评论来解决冲突。(不过，如果您这样做了，请确保将讨论结果记录在CL的评论中，以供将来的读者参考。)</p>
