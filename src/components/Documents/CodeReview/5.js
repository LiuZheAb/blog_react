            ...
            <div className="page-content">
                <div className="article">
                    ...
                    <div className="article-content">
                        ...
                        <h2>给指导</h2>
                        <p className="indent-2"><b>一般来说，修复 CL 是开发人员的责任，而不是评审人员的责任</b>。您不需要为开发人员进行解决方案的详细设计或编写代码。</p>
                        ...
                        <p className="indent-2">然而，有时直接的指令、建议甚至代码更有帮助。代码评审的主要目标是获得尽可能好的 CL 。第二个目标是提高开发人员的技能，这样随着时间的推移，他们需要的评审就会越来越少。</p>
                        <h2>接受解释</h2>
