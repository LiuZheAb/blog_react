            ...
            <div className="page-content">
                <div className="article">
                    ...
                    <div className="article-content">
                        <p className="indent-2">当您发送了一个 CL 供评审时，评审人员很可能会对您的 CL 给出几个评论。下面是一些关于处理评审人员评论的有用信息。</p>
                        <h2>不要把它看成是针对你个人的</h2>
                        ...
                        <h2>独立思考</h2>
                        <p className="indent-2">编写 CL 需要做很多工作。通常情况下，你会很满意自己终于完成了一份评估报告，并确信不需要再做更多的工作。因此，当评审人员回来对可以改进的内容提出评论时，很容易本能地认为这些评论是错误的，审查员不必要地阻止了您，或者他们应该让您提交 CL 。然而，<b>无论您现在有多确定</b>，请花点时间退后一步，考虑评审人员是否提供了有价值的反馈，这将有助于代码库和谷歌。你对自己的第一个问题应该是，“评审人员是正确的吗?”</p>
                        <p className="indent-2">如果你不能回答这个问题，很可能评审人员需要澄清他们的评论。</p>
                        <p className="indent-2">如果您已经考虑过了，并且仍然认为自己是正确的，那么请随意解释为什么您的方法更适合代码库、用户和/或谷歌。通常情况下，评审人员实际上是在提供建议，他们希望您自己考虑什么是最好的。实际上，您可能知道一些关于用户、代码库或 CL 的信息，而评审人员并不知道这些信息。把它们填进去;给他们更多的背景。通常，您可以根据技术事实与评审人员达成一些共识。</p>
                        <h2>解决冲突</h2>
