            ...
            <div className="page-content">
                <div className="article">
                    ...
                    <div className="article-content">
                        ...
                        <h3>术语</h3>
                        <p className="indent-2">其中一些文档中使用了一些 google 内部术语，我们在此向外部读者澄清:</p>
                        <p className="indent-2"><b>CL</b>:代表“变更列表(Change List)”，意思是已经提交到版本控制或正在进行代码评审的一个独立更改。通常将此称为“更改”或“补丁”。</p>
                        <p className="indent-2"><b>LGTM</b>:意思是“看起来不错(Looks Good to Me)”。它是代码审查员在批准 CL 时所说的话。</p>
                        <h3>许可证</h3>
                        <p className="indent-2">本项目中的文档是根据 CC-By 3.0 许可协议授权的，该协议鼓励您共享这些文档。更多信息请参见 <a href="https://creativecommons.org/licenses/by/3.0/" target="_blank" rel="noopener noreferrer">https://creativecommons.org/licenses/by/3.0/</a>。</p>
                        <h2>代码评审者指南</h2>
                        <h3>如何进行代码评审</h3>
                        ...
                        <p className="indent-2">还请参阅代码开发者指南，该指南为正在评审 CLs 的开发人员提供了详细的指导。</p>
                        <h2>代码开发者指南</h2>
