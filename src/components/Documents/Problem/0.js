            ...
            <div className="page-content">
                <div className="article">
                    ...
                    <div className="article-content">
                        ...
                        <h2>问题背景</h2>
                        <p className="indent-2">2020-04-17 晚</p>
                        <p className="indent-2">将文档入口文件的路由配置改为 map 遍历后,引入文档目录组件遇到此问题</p>
                        <h2>问题描述</h2>
                        <p className="indent-2">未解决前代码如下</p>
                        <CodeMirror value={`<Route exact path={gojsData.baseHref} component={<Catalog dataSource={gojsData} />} />`}
                            options={{
                                theme: 'monokai',
                                mode: 'JSX',
                                readOnly: true,
                        ...
                        <CodeMirror value={`<Route exact path={gojsData.baseHref} compontent={() => <Catalog dataSource={gojsData} />} />`}
                            options={{
                                theme: 'monokai',
                                mode: 'JSX',
                                readOnly: true,
